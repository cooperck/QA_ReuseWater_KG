...
class MedicalGraph:
    ...
    def read_nodes(self):
        ...
        for data in open(self.data_path):
            ...
            diseases.append(disease)   #应该是去除重复元素
            disease_dict['desc'] = ''
            ...
            if 'symptom' in data_json: #这也是一个节点
                symptoms += data_json['symptom']
                for symptom in data_json['symptom']:
                    rels_symptom.append([disease, symptom])

            if 'acompany' in data_json: #这也是一个节点
            ...
            if 'cure_department' in data_json: #第一个是大学科，第二个是细分学科
    ...
    '''创建实体关联边''' #定义后给上一个create_graphrels用
